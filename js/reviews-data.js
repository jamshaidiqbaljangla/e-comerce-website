/**
 * BINGO E-commerce Review Data
 * Contains sample review data and utility functions
 */
...
window.REVIEWS = {
    ...
    items: [
        {
            ...
            media: [
                {
                    url: 'images/review-1-image-1.jpg',
                    type: 'image/jpeg'
                },
                {
                    url: 'images/review-1-image-2.jpg',
                    type: 'image/jpeg'
                }
            ]
        },
        {
            ...
            rating: 4,
            title: 'Great Design, Slight Learning Curve',
            content: 'The Signature Collection Item is beautifully designed and clearly made with high-quality materials. The elegant aesthetic complements any setting, and it feels substantial without being bulky. I\'m giving it 4 stars instead of 5 because there is a bit of a learning curve to using it efficiently. The included instructions could be more comprehensive. Once you get the hang of it though, it\'s a joy to use. The customer service team was also very helpful when I reached out with questions. Overall, I\'m satisfied with my purchase and would recommend it to others looking for a premium product in this category.',
            date: '2025-04-02T14:35:42.000Z',
            verifiedPurchase: true,
            helpfulVotes: {
                yes: 18,
                no: 1
        ...
        },
        {
            ...
            rating: 5,
            title: 'A Perfect Gift That Impressed Everyone',
            content: 'I purchased this as a gift for my husband\'s birthday, and it was a huge hit! The packaging is elegant and makes for a wonderful unboxing experience. The product itself exudes luxury and craftsmanship. My husband was thoroughly impressed with both the aesthetics and functionality. Even his colleagues have commented on it during video calls! The personalization option made it even more special. Shipping was faster than expected too. Highly recommend for anyone looking for a gift that will truly stand out and be cherished for years to come.',
            date: '2025-03-28T19:12:05.000Z',
            verifiedPurchase: true,
            helpfulVotes: {
                yes: 15,
                no: 0
            ...
            media: [
                {
                    url: 'images/review-3-image-1.jpg',
                    type: 'image/jpeg'
                }
            ]
        },
        ...
        },
        {
            ...
            media: [
                {
                    url: 'images/review-5-image-1.jpg',
                    type: 'image/jpeg'
                },
                {
                    url: 'images/review-5-image-2.jpg',
                    type: 'image/jpeg'
                },
                {
                    url: 'images/review-5-image-3.jpg',
                    type: 'image/jpeg'
                }
            ]
        },
        {
            ...
            content: 'I had high hopes for this product given the price point and brand reputation. Initially, I was impressed with the design and functionality. However, after just three weeks of regular use, I noticed signs of wear that shouldn\'t be present in a premium item. The finish began to show scratches despite careful handling, and one of the components became loose. Customer service was responsive when I reached out, but I expected better durability from a product marketed as high-end. Perhaps I received a defective unit, but for the price, quality control should be better.',
            date: '2025-03-05T16:28:59.000Z',
            verifiedPurchase: true,
            helpfulVotes: {
                yes: 14,
                no: 8
            ...
            media: [
                {
                    url: 'images/review-6-image-1.jpg',
                    type: 'image/jpeg'
                }
            ]
        },
        {
            ...
            rating: 5,
            title: 'Elegant, Functional, and Sustainable',
            content: 'I\'ve been searching for a product that combines elegant design, practical functionality, and sustainable materials - and the Signature Collection Item delivers on all fronts. The eco-friendly packaging was a great first impression, and the product itself is even better than the photos suggest. The craftsmanship is exceptional, with every detail carefully considered. I especially appreciate the timeless design that won\'t look dated in a few years. It\'s refreshing to find a company that prioritizes both aesthetics and environmental responsibility. This purchase was absolutely worth the premium price for the quality received.',
            date: '2025-02-25T13:45:11.000Z',
            verifiedPurchase: true,
            helpfulVotes: {
                yes: 19,
                no: 0
        ...
        },
        {
            ...
            media: [
                {
                    url: 'images/review-9-image-1.jpg',
                    type: 'image/jpeg'
                },
                {
                    url: 'images/review-9-image-2.jpg',
                    type: 'image/jpeg'
                }
            ]
        },
        ...
        },
        {
            ...
            productId: 'product-1',
            authorId: 'user_111',
            authorName: 'Rachel Taylor',
            rating: 5,
            title: 'Luxury Item That Lives Up To The Hype',
        ...
        // Modern Minimalist Piece - product-2
        {
            id: 'review_13',
            productId: 'product-2',
            authorId: 'user_201',
            ...
            media: [
                {
                    url: 'images/review-13-image-1.jpg',
                    type: 'image/jpeg'
                }
            ]
        },
        {
            ...
            rating: 5,
            title: 'Superior Quality and Design',
            content: 'I\'ve furnished most of my home with minimalist pieces, and this is by far one of the best in terms of quality-to-price ratio. The materials are substantial without being overly heavy, and the construction feels like it will last for years. What sets this apart from similar products is the attention to proportion and scale - it\'s perfectly balanced visually. Assembly was straightforward with clear instructions (a rarity these days). My only small suggestion would be to offer more finish options, but the current selections are versatile enough to work in most spaces. Highly recommend to anyone who appreciates clean, thoughtful design.',
            date: '2025-04-01T09:45:16.000Z',
            verifiedPurchase: true,
            helpfulVotes: {
                yes: 14,
                no: 1
    ...
    getReviewsByProductId: function(productId) {
        return this.items.filter(review => review.productId === productId);
    },
    ...
    getReviewById: function(reviewId) {
        return this.items.find(review => review.id === reviewId) || null;
    },
    ...
    getReviewsByUserId: function(userId) {
        return this.items.filter(review => review.authorId === userId);
    },
    ...
    /**
     * Get the most helpful reviews for a product
     * @param {string} productId - The product ID
     * @param {number} limit - Maximum number of reviews to return
     * @returns {Array} - Array of review objects
     */
    getMostHelpfulReviews: function(productId, limit = 3) {
        const reviews = this.getReviewsByProductId(productId);

        // Sort by helpfulness (yes - no)
        const sortedReviews = reviews.sort((a, b) => {
            const aScore = a.helpfulVotes ? a.helpfulVotes.yes - a.helpfulVotes.no : 0;
            const bScore = b.helpfulVotes ? b.helpfulVotes.yes - b.helpfulVotes.no : 0;
    ...
    /**
     * Get reviews with media for a product
     * @param {string} productId - The product ID
     * @returns {Array} - Array of review objects
     */
    getReviewsWithMedia: function(productId) {
        const reviews = this.getReviewsByProductId(productId);
        return reviews.filter(review => review.media && review.media.length > 0);
    },

    /**
     * Add a new review (normally this would be an API call)
     * @param {Object} reviewData - The review data
     * @returns {Object} - The new review object
     */
    addReview: function(reviewData) {
        ...
        this.items.unshift(newReview);
        return newReview;
    },

    /**
     * Vote on a review (normally this would be an API call)
     * @param {string} reviewId - The review ID
...
console.log('[DEBUG] reviews-data.js: REVIEWS object initialized with sample data');